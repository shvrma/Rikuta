...
using Rikuta.Models.RequestModel.ApplicatioonCommands;
...
public interface IDiscordApplicationsApi
{
    ...
    /// properties <see cref="ApplicationCommand.LocalizedCommandName"/> and
    ...
    /// </summary>
    /// <remarks>
    /// If the application locale is set, the response will include properties
    ...
    /// Read about it <see href="https://discord.com/developers/docs/interactions/application-commands#permissions">there</see>.
    /// </remarks>
    /// <param name="applicationID">
    /// A <see cref="Snowflake"/> ID of application.
    /// </param>
